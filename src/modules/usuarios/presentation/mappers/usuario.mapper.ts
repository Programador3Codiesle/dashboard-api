...
export class UsuarioMapper {
  ...
  static mapUsuariosBD(row: any): UsuarioEntity {
    return new UsuarioEntity({
      id_empleado:
        row.id_empleado !== null ? row.id_empleado.toString() : undefined,
      ...
      createdAt: row.fecha_hora_crea_usu
        ? new Date(row.fecha_hora_crea_usu)
        : undefined,
      updatedAt: row.fecha_hora_mod_usu
        ? new Date(row.fecha_hora_mod_usu)
        : undefined,
    });
  }
