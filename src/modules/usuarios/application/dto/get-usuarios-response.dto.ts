...
export class GetUsuariosResponseDto {
  ...
  @ApiProperty({
    ...
    description: 'Nombres completos del tercero',
  })
  ...
  @ApiProperty({
    example: 'Administrador Postventa',
  ...
  @ApiProperty({
    example: 'Codiesel, Dieselco, Mitsubishi',
  ...
  @ApiProperty({
    example: 'Activo',
    description: 'Estado formateado para display',
  })
  estadoDisplay?: string;

  @ApiProperty({
    example: '15 de enero de 2024, 10:30',
  ...
  @ApiProperty({
    example: true,
    description: 'Indica si tiene empresa asignada',
  })
