...
export class CreateFormatoDesempenoDto {
  ...
  @ApiProperty({
    example: 5,
    description: 'Trabajo en equipo (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Participa activamente (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Propone iniciativas (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Relaciones interpersonales (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Comunicación efectiva (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Discreción (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Responsabilidad (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Acatamiento (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Compromiso (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Conocimiento procesos (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Conocimiento metas (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Adaptabilidad (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Control estrés (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Solución conflictos - escucha (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Solución conflictos - estrategia (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 4,
    description: 'Soluciones adecuadas (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Identifica cliente (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Servicio al cliente (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Participa capacitación (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Informa peligros (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Informa accidentes (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Informa salud (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Usa EPP (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Llamados atención (Auto-evaluación)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 5,
    description: 'Accidentes trabajo (Auto-evaluación)',
    required: false,
  })
