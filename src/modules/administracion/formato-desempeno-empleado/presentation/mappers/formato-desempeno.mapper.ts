...
export class FormatoDesempenoMapper {
    /**
     * Mapea la entidad FormatoDesempenoEntity a un objeto serializable
     ...
     */
    static toResponse(entity: FormatoDesempenoEntity | null): any {
        if (!entity) {
            return null;
        }
