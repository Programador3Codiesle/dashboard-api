        ...
        return {
            items: result.items.map((item) => {
                ...
                return {
                    ...
                    fecha_solicitud: entity.fecha_solicitud.toLocaleDateString('sv-SE', { timeZone: 'America/Bogota' }),
                    area: entity.area,
                    sede: entity.sede,
                    ...
                    fecha_tentativa: entity.fecha_tentativa.toLocaleDateString('sv-SE', { timeZone: 'America/Bogota' }),
                    estado: entity.estado,
                    fecha_autorizacion: entity.fecha_autorizacion
                        ? entity.fecha_autorizacion.toLocaleDateString('sv-SE', { timeZone: 'America/Bogota' })
                        : null,
