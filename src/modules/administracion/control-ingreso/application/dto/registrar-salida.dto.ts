...
export class RegistrarSalidaDto {
    ...
    @IsOptional()
    @IsNumber()
    @ApiProperty({ example: 2020, description: 'Modelo del vehículo', required: false })
    modelo?: number;

    @IsOptional()
    @IsString()
    @ApiProperty({ example: 'Taller 1', description: 'Taller destino', required: false })
    taller?: string;

    @IsString()
    @ApiProperty({ example: 'Juan Pérez', description: 'Nombre de quien conduce' })
    conductor: string;
    ...
    @IsOptional()
    @IsString()
    @ApiProperty({ example: 'Marca Externa', description: 'Otra marca del vehículo', required: false })
    otra_marca?: string;

    @IsOptional()
    @IsString()
    @ApiProperty({ example: 'GRU123', description: 'Placa de la grúa', required: false })
