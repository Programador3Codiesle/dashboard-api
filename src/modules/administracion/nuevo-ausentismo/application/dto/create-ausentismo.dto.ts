...
export class CreateAusentismoDto {
  ...
  @ApiProperty({
    example: '2025-01-15',
    description: 'Fecha en la que se ausentará',
  })
  fecha_ini: string;
  ...
  @ApiProperty({
    example: '08:00',
    description: 'Hora inicio ausentismo',
    required: false,
  })
  hora_ini?: string;
  ...
  @ApiProperty({
    example: '17:00',
    description: 'Hora en que termina el ausentismo',
  })
  hora_fin: string;
  ...
  @IsString()
  @ApiProperty({
    example: 'Descripción detallada del motivo',
    description: 'Describe el motivo del permiso',
  })
  descripcion: string;
