...
import { IAjusteValoresRepository, RepositoryResponse } from '../../domain/ajuste-valores.repository';
...
export class ObtenerValoresUseCase {
    ...
    async execute(tipo: string, numero: number): Promise<RepositoryResponse<ResponseAjusteValoresDto>> {
    ...
    async obtenerValores2(tipo: string, numero: number): Promise<RepositoryResponse<ResponseAjusteValoresDto>> {
    ...
    async obtenerValoresCruce(tipo: string, numero: number): Promise<RepositoryResponse<ResponseAjusteValoresDto>> {
    ...
    async validarDocumentosCerrados(ano: number, mes: number): Promise<RepositoryResponse<{ cerrado: boolean }>> {
