/**
 * Configuración de marcas para el PDF de cotización (alineada con globals.css y usuarios/constants).
 * Colores en RGB 0-1 para pdf-lib.
 */
export type IdEmpresa = 1 | 2 | 3 | 4;

export interface BrandPdfColors {
  /** Color principal (--color-primary): encabezados, barra superior, totales */
  primary: { r: number; g: number; b: number };
  /** Tono claro (--color-primary-light): subencabezados de tabla */
  primaryLight: { r: number; g: number; b: number };
  /** Texto sobre primary: blanco para buen contraste */
...
/**
 * Obtiene la config de marca para el PDF. Si idEmpresa no es 1-4, usa Codiesel (default).
 */
